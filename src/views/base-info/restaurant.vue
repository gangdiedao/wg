<template>
  <div class="app-container">
    ...
    <restaurantAddOrUpdate ref="restaurantAddOrUpdate" />
  </div>
</template>
...
import restaurantAddOrUpdate from './components/restaurant-add-or-update' // secondary package based on el-pagination
...
export default {
  ...
  methods: {
    ...
    handleCreateUpdate(item) {
      this.$refs.restaurantAddOrUpdate.init(item ? JSON.parse(JSON.stringify(item)) : item)
    },
    // 删除
